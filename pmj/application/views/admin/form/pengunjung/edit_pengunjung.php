<form action="<?php echo base_url('user/admin/pengunjung/simpanedit/'.$id_pengunjung) ?>" method='post'>
 <div class="row">
    <div class="col-md-6">
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Edit Penunjung</h3>
        ...
        <div class="box-body">
            ...
            <div class="form-group">
              ...
              <select name="kategori" class="form-control" id="kategori">
                ...
                <option value="Pribadi" <?php if($pesanan->num_rows()>0 || $pengunjung['kategori']=='Pribadi'){echo "selected";} ?>>Pribadi</option>
                <option value="Kelompok" <?php if($pengunjung['kategori']=='Kelompok'){echo "selected";} ?>>Kelompok</option>
              </select>
            </div>
            ...
            <div class="form-group">
              <input type="hidden" name="id_pelanggan_pemesan" id="id_pelanggan_pemesan" value="<?php echo $id_pelanggan_edit ?>">
              <table class="table">
                <tr>
          ...
          <table class="table table-striped table-bordered" id="tabel1">
            ...
            foreach ($pelanggan as $d1) { ?>
              <tr>
                ...
                <td><input type="radio" name="id_pelanggan_pilih" class="id_pelanggan_terpilih" value="<?php echo $d1['id_pelanggan'] ?>" <?php if($id_pelanggan_edit==$d1['id_pelanggan']){echo "checked";} ?>></td>
  ...
  <div class="row" id="f_produk_keranjang" <?php if($pengunjung['kategori']=='Kelompok'){echo 'style="display: none"';} ?>>
            ...
            foreach ($pesanan->result_array() as $d1) { 
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href="<?php echo base_url('user/admin/pengunjung/hapus_pesanan/'.$d1['id_pesanan'].'/edit/'.$id_pengunjung) ?>" class="btn btn-info btn-xs" onclick="return">Hapus</a>
...
<form action="<?php echo base_url('user/admin/pengunjung/edit_masuk_ke_keranjang/'.$id_pengunjung) ?>" method="post" id="form_pesanan_produk">
...
<script type="text/javascript">
  identitas_pemesan_aktif(<?php echo $pengunjung['id_pelanggan'] ?>, '<?php echo $pengunjung['kategori'] ?>');
  ...
  function detail_produk(nama_produk, id_produk, harga_produk, qty, action, id_pesanan){
    ...
    if (action=='edit') {
      $('#form_pesanan_produk').attr('action', '<?php echo base_url('user/admin/pengunjung/edit_simpanedit_keranjang/'.$id_pengunjung) ?>');

    }else{
      $('#form_pesanan_produk').attr('action', '<?php echo base_url('user/admin/pengunjung/edit_masuk_ke_keranjang/'.$id_pengunjung) ?>');
    }
  }
